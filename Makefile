all: son/son sip/sip client/app_simple_client server/app_simple_server client/app_stress_client server/app_stress_server IM/client/IM_client IM/server/IM_server
...
son/son: topology/topology.o common/pkt.o son/neighbortable.o son/son.c common/seg.o
...
IM/client/IM_client:IM/client/client.o
	gcc -Wall -pedantic -std=c99 -g -pthread IM/client/client.o -o IM/client/IM_client
IM/client/client.o: IM/client/client.c IM/client/client.h IM/client/const.h
	gcc -Wall -pedantic -std=c99 -g -c IM/client/client.c -o IM/client/client.o

IM/server/IM_server:IM/server/server.o 
	gcc -Wall -pedantic -std=c99 -g -pthread IM/server/server.o -o IM/server/IM_server
IM/server/server.o: IM/server/server.c IM/server/server.h IM/server/const.h 
	gcc -Wall -pedantic -std=c99 -g -c IM/server/server.c -o IM/server/server.o
...
clean:
	...
	rm -rf IM/server/server.o IM/client/client.o
	rm -rf IM/client/IM_client IM/server/IM_server
git:
	git add .
	git commit -m '123'
